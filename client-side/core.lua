...
local Crafting = {
	...
	["4"] = { vec3(-355.16,-1513.31,27.72),"Lixeiro" },
	["5"] = { vec3(287.36,2843.6,44.7),"Lixeiro" },
	["6"] = { vec3(-413.68,6171.99,31.48),"Lixeiro" },
	["7"] = { vec3(2921.17,2653.46,43.31),"Mining" },
	["8"] = { vec3(4909.82,-5287.18,-1.38),"Money" }, 
	["9"] = { vec3(1209.28,-3115.1,5.61),"Weapons" },
	-- Restaurants
	["10"] = { vec3(-1075.72,-1446.42,-1.42),"Oriental" },
	["11"] = { vec3(-588.54,-1059.61,22.36),"UwuCoffee" },
	-- Contraband
	["12"] = { vec3(-652.99,-1230.55,11.54),"Chiliad" },
	["13"] = { vec3(-161.72,-1609.33,33.46),"Families" },
	["14"] = { vec3(1421.29,6328.41,23.87),"Highways" },
	["15"] = { vec3(325.69,-1997.49,24.02),"Vagos" },
	-- Favelas
	["16"] = { vec3(5148.15,-5119.8,2.41),"Barragem" },
	["17"] = { vec3(3176.13,5142.38,31.51),"Farol" },
	["18"] = { vec3(402.93,756.95,194.62),"Parque" },
	["19"] = { vec3(2175.04,4045.95,34.36),"Sandy" },
	["20"] = { vec3(1550.16,-2454.24,80.37),"Petroleo" },
	["21"] = { vec3(5110.84,-4685.15,2.68),"Praia-1" },
	["22"] = { vec3(-3130.2,1702.83,41.01),"Praia-2" },
	["23"] = { vec3(-601.03,2197.69,126.27),"Zancudo" },
	-- Mafias
	["24"] = { vec3(-1871.2,2061.28,135.28),"Madrazzo" },
	["25"] = { vec3(-1543.54,79.91,57.00),"Playboy" },
	["26"] = { vec3(-1474.44,-46.27,62.02),"TheSouth" },
	["27"] = { vec3(-781.22,808.9,210.4),"Yamaguchi" },
	["28"] = { vec3(816.6,-956.33,22.09),"Mechanic" },
	["29"] = { vec3(4992.52,-5137.54,-4.48),"Pedreira1" },
	["30"] = { vec3(4904.43,-5287.22,-1.38),"Money" },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
